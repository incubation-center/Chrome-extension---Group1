...
request.open("GET", URL, true); //AJAX Asynchronous = true

// only start when emojis are loaded successfully
// onreadystatechange : define function to be execute when status of the XMLHttpRequest change
                ...
                if (box !== undefined) {
                  ...
                  document
                    .getElementsByClassName(
                      "VfPpkd-Bz112c-LgbsSe yHy1rc eT1oJ tWDL4c Cs0vCd" // class for send button on chat
                    )[0]
